...
import { ArrowRight, Info, Ruler, Scale, UserRound } from 'lucide-react';
    ...
    <main className="screen-page">
      ...
      <div className="profile-layout">
        <form className="panel profile-form" onSubmit={handleSubmit} noValidate>
          <div className="section-title"><UserRound size={20} /><div><h2>Your basics</h2><p>Used only on this device.</p></div></div>
